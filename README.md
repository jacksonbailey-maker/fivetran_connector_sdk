...
- ehi
  - [simple_ehi](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/ehi/simple_ehi) - This example shows how to sync EHI tables such as Caboodle using Connector SDK. It connects to Microsoft SQL server to sync the data. You need to provide your server credentials for this example to work.
  - [high_volume_ehi](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/ehi/high_volume_ehi) - This example demonstrates how to sync high-volume EHI tables such as Caboodle using Connector SDK. It connects to Microsoft SQL server to sync the data. The connector implements optimizations for high-volume tables, including parallel schema discovery, efficient pagination using replication key seeking, and batch processing of records. You need to provide your server credentials for this example to work.
